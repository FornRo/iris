...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_GRV, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO, KC_TRNS, KC_EQL, RCS(KC_TAB), LCTL(KC_TAB), KC_UNDS, KC_MINS, KC_PLUS, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, KC_TRNS, LCTL_T(KC_CAPS), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_BSPC, KC_BTN3, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_PSCR, KC_TRNS, TO(4), KC_NO, KC_NO, KC_APP, KC_DEL, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
